...
# Alican Tanaçan
# Version 2 - Preprocessing and Feature Engineering
...
# Selected Variables: "Price", "RecommendProduct", "PositiveServiceReview",
# "StarWeighted" and "Volume."
...
preProcValues
set.seed(400)
kNNControl1 <- trainControl(method="repeatedcv",

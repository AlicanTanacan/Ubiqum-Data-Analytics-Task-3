...
# Alican Tanaçan
# Version 5 - Creating Models for PositiveServiceReview, StarWeighted, TotalStars
...
## Feature Selection ----
# To remove highly correlated / colinear variables:
ExProdReady[,c(1:18, 20:26)] <- list(NULL)
...
write.csv(NewProductsData, file="newproductspredictions5.csv", row.names = TRUE)
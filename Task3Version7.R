...
# Alican Tanaçan
# Version 7 - Creating Models for PositiveServiceReview, NegativeServiceReview, RecommendProduct
...
ExProdReady[,c(1:18, 22:26, 28:29)] <- list(NULL)
...
write.csv(NewProductsData, file="newproductspredictions7.csv", row.names = TRUE)